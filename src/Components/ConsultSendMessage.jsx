...
const ConsultSendMessage = ({
  ...
  const HandleSend = async () => {
    if (sms == "" || sms == null) {
      ...
      bodyform.append("FK_cases_ID", cases.data.PK_cases_ID);
  ...
  return (
    <div>
      <Text mb={4} fontWeight={"bold"}>
        ...
        {responses.data.length === 1 ? " reponse" : " responses"}
      </Text>
      <Box>
        <Textarea
      ...
      <Stack direction={"row"} mt={10}>
        <Box>
          <Menu>
            ...
            <MenuList fontSize={"14px"} onClick={handleSort}>
...
ConsultSendMessage.propTypes = {
  cases: PropTypes.object,
  handleSort: PropTypes.function,
  responses: PropTypes.data,
  sort: PropTypes.string,
  setFetch: PropTypes.function,
};
