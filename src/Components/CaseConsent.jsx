...
const CaseConsent = ({ isOpen, onClose, setDissable, redirect, dissable }) => {
  return (
    <Modal size={"full"} isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <Checkbox onChange={() => setDissable(!dissable)}></Checkbox>
        </ModalBody>
        <ModalFooter>
...
CaseConsent.propTypes = {
  isOpen: PropTypes.bool,
  onClose: PropTypes.bool,
  setDissable: PropTypes.function,
  redirect: PropTypes.function,
  dissable: PropTypes.bool,
};

export default CaseConsent;
