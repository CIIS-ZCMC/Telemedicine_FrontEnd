...
const ConsultMessages = ({ messages, descending }) => {
  if (messages.data.length === 0 || messages.data === undefined) {
    return (
    ...
    <>
      <Box borderTop={"1px solid #CBD5E0"} borderRadius={5}>
        ...
        <Box p={5}>
          ...
          {/* {messages.files.length === 0 ? null : <HundleCouresel />} */}
          {messages.files.length === 0 ? null : (
